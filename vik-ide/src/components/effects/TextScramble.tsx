...
//   words: "[enter text]"
//   font: {"variant":"Bold","fontSize":120,"textAlign":"left","fontFamily":"Inter","fontWeight":700,"lineHeight":"1em","letterSpacing":"2em"}
...
export default function GlitchCharReveal(props: any) {
    ...
    const [_placedChars, setPlacedChars] = useState<Record<number, number[]>>({})
